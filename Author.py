...
class AuthorFrame(customtkinter.CTkFrame):
    ...
    def author_rename_dialogue(
        self,
        window: customtkinter.CTkToplevel,
        tags_json: str,
        author_to_rename: str,
        author_array: list[str],
        author_loader: dict,
        library_json: str,
        authors_json: str,
        bookframe,
    ...
    def __init__(
        ...
        **kwargs
        ...
        # make the buttons
        self.author_append = customtkinter.CTkButton(
            self,
            image=ctk_add,
            compound="left",
            anchor="center",
