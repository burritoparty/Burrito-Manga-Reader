...
class TagFrame(customtkinter.CTkFrame):
    ...
    def tag_delete_call(self, tags_json: str, window: customtkinter.CTkToplevel | None):
    ...
    def __init__(self, tag_json: str, bookframe: BookFrame, master: customtkinter.CTk, **kwargs):
